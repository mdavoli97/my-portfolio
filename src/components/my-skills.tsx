  ...
  return (
    <div className="space-y-5 max-w-prose">
      ...
      <div className="space-y-3">
        ...
        <p className="text-sm flex flex-col gap-2">
          <span>
            JavaScript - ES2020, HTML, CSS - Tailwind, Bootstrap, ReactJS, React
            Native, Redux - Redux Thunk/Toolkit, Web Services - REST, Axios,
            React-Query, WebSockets - Git - GitHub, GitLab - AWS AppSync, Type
            Checking - TypeScript, NodeJS - Animations - Keyframes, Framer
            Motion, CSS-in-JS - Styled Components, Emotion, JSS, Google Maps,
            React UI Frameworks - Material UI, Ant Design, Theme UI, Radix UI,
            SSR & PWA - NextJS, GatsbyJS
          </span>
        </p>
      </div>
